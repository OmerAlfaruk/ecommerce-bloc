...
import 'package:ecommers/presentation/home/bloc/display_user_info/user_info_display_cubit.dart';
import 'package:ecommers/presentation/home/bloc/display_user_info/user_info_display_state.dart';
import 'package:ecommers/presentation/setting/pages/setting.dart';
...
return Center(child: CircularProgressIndicator(),);
          ...
          return Container(
            ...
            child: Row(
              ...
              children: [_profileImage(state.user,context), _gender(state.user), _card(context)],
            ),
          );}
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: user.image.isNotEmpty?NetworkImage(user.image):const AssetImage(AppImages.profile)),
